...
# Code follows:
var.registers(['hierarchy2String', 'ontology2Labels', 'camelCase', 'editString2Docs', 'getChildren', 'uuidv4', 'fillDocBeforeCreate'])
@Js
...
def PyJsHoisted_fillDocBeforeCreate_(data, docType, this, arguments, var=var):
    ...
    var.registers(['rating', 'i', 'initSpaces', 'line', 'now', 'text', 'docType', 'keys', 'prefixJ', 'fields', 'prefix', 'otherTags', 'data'])
...
def PyJsHoisted_hierarchy2String_(data, addID, callback, detail, magicTags, this, arguments, var=var):
    ...
    var.registers(['magicTags', 'callback', 'i', 'key', 'value', 'dataList', 'outString', 'addID', 'detail', 'childNum', 'hierString', 'data', 'keys', 'compare', 'hierarchyIDs', 'j', 'id'])
    @Js
    ...
    def PyJs_anonymous_4_(item, this, arguments, var=var):
        var = Scope({'item':item, 'this':this, 'arguments':arguments}, var)
        var.registers(['spaces', 'partString', 'i1', 'hierarchyArray', 'i', 'doc', 'item', 'docID', 'prefix', 'i2', 'i3'])
...
def PyJsHoisted_editString2Docs_(text, magicTags, this, arguments, var=var):
    ...
    var.registers(['magicTags', 'i', 'docI', 'parts', 'line', 'text', 'docID', 'docs', 'comment', 'objective', 'title', 'docType', 'j', 'tags'])
    var.put('docs', Js([]))
...
def PyJsHoisted_getChildren_(data, docID, this, arguments, var=var):
    ...
    var.registers(['names', 'i', 'nStars', 'docID', 'numStarsParent', 'ids', 'items', 'saveLine', 'data', 'lines'])
    var.put('names', Js([]))
    var.put('ids', Js([]))
