...
# Code follows:
var.registers(['fillDocBeforeCreate', 'ontology2Labels', 'uuidv4', 'hierarchy2String', 'camelCase', 'getChildren', 'editString2Docs'])
@Js
...
def PyJsHoisted_fillDocBeforeCreate_(data, docType, this, arguments, var=var):
    ...
    var.registers(['line', 'rating', 'otherTags', 'prefix', 'protectedKeys', 'data', 'prefixJ', 'keys', 'now', 'fields', 'text', 'docType', 'i', 'initSpaces'])
...
def PyJsHoisted_hierarchy2String_(data, addID, callback, detail, magicTags, this, arguments, var=var):
    ...
    var.registers(['j', 'dataList', 'callback', 'detail', 'compare', 'hierString', 'id', 'data', 'keys', 'addID', 'childNum', 'value', 'key', 'outString', 'i', 'magicTags', 'hierarchyIDs'])
    @Js
    ...
    def PyJs_anonymous_5_(item, this, arguments, var=var):
        var = Scope({'item':item, 'this':this, 'arguments':arguments}, var)
        var.registers(['prefix', 'partString', 'i2', 'item', 'hierarchyArray', 'i3', 'i1', 'doc', 'docID', 'spaces', 'i'])
...
def PyJsHoisted_editString2Docs_(text, magicTags, this, arguments, var=var):
    ...
    var.registers(['docI', 'line', 'j', 'tags', 'comment', 'objective', 'text', 'parts', 'docID', 'docType', 'i', 'magicTags', 'docs', 'title'])
    var.put('docs', Js([]))
...
def PyJsHoisted_getChildren_(data, docID, this, arguments, var=var):
    ...
    var.registers(['nStars', 'data', 'names', 'numStarsParent', 'ids', 'items', 'docID', 'saveLine', 'i', 'lines'])
    var.put('names', Js([]))
    var.put('ids', Js([]))
