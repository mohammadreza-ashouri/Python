...
# Code follows:
var.registers(['uuidv4', 'hierarchy2String', 'ontology2Labels', 'getChildren', 'editString2Docs', 'fillDocBeforeCreate', 'camelCase'])
@Js
...
def PyJsHoisted_fillDocBeforeCreate_(data, docType, this, arguments, var=var):
    ...
    var.registers(['prefix', 'prefixJ', 'protectedKeys', 'initSpaces', 'rating', 'otherTags', 'fields', 'data', 'now', 'keys', 'text', 'i', 'line', 'docType'])
...
def PyJsHoisted_hierarchy2String_(data, addID, callback, detail, magicTags, this, arguments, var=var):
    ...
    var.registers(['value', 'id', 'key', 'outString', 'data', 'detail', 'keys', 'addID', 'j', 'dataList', 'compare', 'hierarchyIDs', 'i', 'childNum', 'hierString', 'magicTags', 'callback'])
    @Js
    ...
    def PyJs_anonymous_5_(item, this, arguments, var=var):
        var = Scope({'item':item, 'this':this, 'arguments':arguments}, var)
        var.registers(['prefix', 'i3', 'hierarchyArray', 'i2', 'partString', 'doc', 'i', 'spaces', 'item', 'docID', 'i1'])
...
def PyJsHoisted_editString2Docs_(text, magicTags, this, arguments, var=var):
    ...
    var.registers(['tags', 'comment', 'i', 'docI', 'text', 'docs', 'j', 'parts', 'title', 'objective', 'docID', 'line', 'magicTags', 'docType'])
    var.put('docs', Js([]))
...
def PyJsHoisted_getChildren_(data, docID, this, arguments, var=var):
    ...
    var.registers(['saveLine', 'ids', 'items', 'data', 'i', 'lines', 'nStars', 'names', 'numStarsParent', 'docID'])
    var.put('names', Js([]))
    var.put('ids', Js([]))
...
# HASH: 80a2658e3e167ff9c42c17595d3674f34b6bfef6