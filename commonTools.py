...
# Code follows:
var.registers(['camelCase', 'ontology2Labels', 'hierarchy2String', 'getChildren', 'fillDocBeforeCreate', 'editString2Docs', 'uuidv4'])
@Js
...
def PyJsHoisted_fillDocBeforeCreate_(data, docType, this, arguments, var=var):
    ...
    var.registers(['docType', 'rating', 'otherTags', 'fields', 'text', 'initSpaces', 'keys', 'line', 'data', 'prefixJ', 'now', 'prefix', 'i'])
...
def PyJsHoisted_hierarchy2String_(data, addID, callback, detail, magicTags, this, arguments, var=var):
    ...
    var.registers(['childNum', 'dataList', 'magicTags', 'id', 'compare', 'key', 'hierString', 'keys', 'j', 'data', 'addID', 'value', 'outString', 'callback', 'i', 'detail', 'hierarchyIDs'])
    @Js
    ...
    def PyJs_anonymous_4_(item, this, arguments, var=var):
        var = Scope({'item':item, 'this':this, 'arguments':arguments}, var)
        var.registers(['hierarchyArray', 'i2', 'partString', 'i3', 'item', 'docID', 'doc', 'i1', 'spaces', 'i', 'prefix'])
...
def PyJsHoisted_editString2Docs_(text, magicTags, this, arguments, var=var):
    ...
    var.registers(['tags', 'docType', 'comment', 'docs', 'parts', 'magicTags', 'docI', 'text', 'j', 'docID', 'line', 'objective', 'i', 'title'])
    var.put('docs', Js([]))
...
def PyJsHoisted_getChildren_(data, docID, this, arguments, var=var):
    ...
    var.registers(['saveLine', 'lines', 'names', 'nStars', 'docID', 'data', 'items', 'ids', 'numStarsParent', 'i'])
    var.put('names', Js([]))
    var.put('ids', Js([]))
