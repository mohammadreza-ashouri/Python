...
# Code follows:
var.registers(['ontology2Labels', 'fillDocBeforeCreate', 'uuidv4', 'getChildren', 'hierarchy2String', 'editString2Docs', 'camelCase'])
@Js
...
def PyJsHoisted_fillDocBeforeCreate_(data, docType, this, arguments, var=var):
    ...
    var.registers(['line', 'otherTags', 'text', 'initSpaces', 'i', 'keys', 'docType', 'prefixJ', 'now', 'data', 'rating', 'prefix', 'fields'])
...
def PyJsHoisted_hierarchy2String_(data, addID, callback, detail, magicTags, this, arguments, var=var):
    ...
    var.registers(['magicTags', 'addID', 'dataList', 'data', 'j', 'value', 'detail', 'outString', 'keys', 'i', 'childNum', 'hierString', 'hierarchyIDs', 'compare', 'id', 'callback', 'key'])
    @Js
    ...
    def PyJs_anonymous_4_(item, this, arguments, var=var):
        var = Scope({'item':item, 'this':this, 'arguments':arguments}, var)
        var.registers(['i1', 'i2', 'i3', 'i', 'spaces', 'partString', 'docID', 'hierarchyArray', 'item', 'doc', 'prefix'])
...
def PyJsHoisted_editString2Docs_(text, magicTags, this, arguments, var=var):
    ...
    var.registers(['magicTags', 'parts', 'comment', 'line', 'title', 'j', 'text', 'tags', 'i', 'docI', 'docs', 'docID', 'objective', 'docType'])
    var.put('docs', Js([]))
...
def PyJsHoisted_getChildren_(data, docID, this, arguments, var=var):
    ...
    var.registers(['saveLine', 'nStars', 'ids', 'lines', 'items', 'i', 'numStarsParent', 'docID', 'data', 'names'])
    var.put('names', Js([]))
    var.put('ids', Js([]))
