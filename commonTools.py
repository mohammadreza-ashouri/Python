...
# Code follows:
var.registers(['camelCase', 'hierarchy2String', 'editString2Docs', 'fillDocBeforeCreate', 'uuidv4', 'getChildren', 'ontology2Labels'])
@Js
...
def PyJsHoisted_fillDocBeforeCreate_(data, docType, this, arguments, var=var):
    ...
    var.registers(['text', 'prefix', 'docType', 'fields', 'rating', 'initSpaces', 'prefixJ', 'now', 'keys', 'data', 'line', 'otherTags', 'i'])
...
def PyJsHoisted_ontology2Labels_(ontology, tableFormat, this, arguments, var=var):
    ...
    var.registers(['ontology', 'dataDict', 'hierarchyDict', 'tableFormat'])
    var.put('dataDict', Js({}))
...
def PyJsHoisted_hierarchy2String_(data, addID, callback, detail, magicTags, this, arguments, var=var):
    ...
    var.registers(['value', 'id', 'hierString', 'key', 'detail', 'addID', 'dataList', 'keys', 'outString', 'hierarchyIDs', 'childNum', 'data', 'callback', 'magicTags', 'compare', 'i', 'j'])
    @Js
    ...
    def PyJs_anonymous_4_(item, this, arguments, var=var):
        var = Scope({'item':item, 'this':this, 'arguments':arguments}, var)
        var.registers(['prefix', 'partString', 'spaces', 'docID', 'i2', 'hierarchyArray', 'item', 'i1', 'doc', 'i', 'i3'])
...
def PyJsHoisted_editString2Docs_(text, magicTags, this, arguments, var=var):
    ...
    var.registers(['text', 'docType', 'title', 'tags', 'comment', 'docID', 'docs', 'line', 'docI', 'magicTags', 'objective', 'i', 'parts', 'j'])
    var.put('docs', Js([]))
...
def PyJsHoisted_getChildren_(data, docID, this, arguments, var=var):
    ...
    var.registers(['names', 'items', 'nStars', 'lines', 'docID', 'numStarsParent', 'data', 'ids', 'i', 'saveLine'])
    var.put('names', Js([]))
    var.put('ids', Js([]))
