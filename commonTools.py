...
# Code follows:
var.registers(['editString2Docs', 'hierarchy2String', 'getChildren', 'camelCase', 'uuidv4', 'fillDocBeforeCreate', 'ontology2Labels'])
@Js
...
def PyJsHoisted_fillDocBeforeCreate_(data, docType, this, arguments, var=var):
    ...
    var.registers(['prefix', 'i', 'data', 'keys', 'text', 'now', 'rating', 'otherTags', 'initSpaces', 'prefixJ', 'fields', 'line', 'docType'])
...
def PyJsHoisted_ontology2Labels_(ontology, tableFormat, this, arguments, var=var):
    ...
    var.registers(['ontology', 'hierarchyDict', 'dataDict', 'tableFormat'])
    var.put('dataDict', Js({}))
...
def PyJsHoisted_hierarchy2String_(data, addID, callback, detail, magicTags, this, arguments, var=var):
    ...
    var.registers(['detail', 'magicTags', 'dataList', 'i', 'data', 'j', 'hierString', 'callback', 'hierarchyIDs', 'keys', 'childNum', 'key', 'id', 'outString', 'value', 'compare', 'addID'])
    @Js
    ...
    def PyJs_anonymous_4_(item, this, arguments, var=var):
        var = Scope({'item':item, 'this':this, 'arguments':arguments}, var)
        var.registers(['item', 'prefix', 'docID', 'i', 'hierarchyArray', 'partString', 'spaces', 'doc', 'i1', 'i3', 'i2'])
...
def PyJsHoisted_editString2Docs_(text, magicTags, this, arguments, var=var):
    ...
    var.registers(['magicTags', 'docID', 'docs', 'objective', 'tags', 'i', 'j', 'comment', 'text', 'docI', 'parts', 'title', 'line', 'docType'])
    var.put('docs', Js([]))
...
def PyJsHoisted_getChildren_(data, docID, this, arguments, var=var):
    ...
    var.registers(['numStarsParent', 'lines', 'data', 'i', 'items', 'docID', 'saveLine', 'names', 'ids', 'nStars'])
    var.put('names', Js([]))
    var.put('ids', Js([]))
