...
# Code follows:
var.registers(['editString2Docs', 'getChildren', 'ontology2Labels', 'hierarchy2String', 'camelCase', 'fillDocBeforeCreate', 'uuidv4'])
@Js
...
def PyJsHoisted_fillDocBeforeCreate_(data, docType, this, arguments, var=var):
    ...
    var.registers(['rating', 'text', 'docType', 'otherTags', 'keys', 'prefixJ', 'prefix', 'i', 'fields', 'line', 'now', 'data', 'initSpaces'])
...
def PyJsHoisted_ontology2Labels_(ontology, tableFormat, this, arguments, var=var):
    ...
    var.registers(['ontology', 'tableFormat', 'hierarchyDict', 'dataDict'])
    var.put('dataDict', Js({}))
...
def PyJsHoisted_hierarchy2String_(data, addID, callback, detail, magicTags, this, arguments, var=var):
    ...
    var.registers(['dataList', 'childNum', 'id', 'addID', 'key', 'keys', 'j', 'detail', 'compare', 'data', 'i', 'outString', 'hierString', 'value', 'hierarchyIDs', 'magicTags', 'callback'])
    @Js
    ...
    def PyJs_anonymous_4_(item, this, arguments, var=var):
        var = Scope({'item':item, 'this':this, 'arguments':arguments}, var)
        var.registers(['partString', 'i3', 'hierarchyArray', 'prefix', 'i', 'i2', 'item', 'i1', 'doc', 'docID', 'spaces'])
...
def PyJsHoisted_editString2Docs_(text, magicTags, this, arguments, var=var):
    ...
    var.registers(['text', 'docType', 'comment', 'objective', 'docI', 'parts', 'j', 'i', 'docs', 'title', 'line', 'tags', 'docID', 'magicTags'])
    var.put('docs', Js([]))
...
def PyJsHoisted_getChildren_(data, docID, this, arguments, var=var):
    ...
    var.registers(['numStarsParent', 'names', 'items', 'docID', 'ids', 'lines', 'nStars', 'i', 'saveLine', 'data'])
    var.put('names', Js([]))
    var.put('ids', Js([]))
