...
# Code follows:
var.registers(['fillDocBeforeCreate', 'hierarchy2String', 'getChildren', 'editString2Docs', 'uuidv4', 'ontology2Labels', 'camelCase'])
@Js
...
def PyJsHoisted_fillDocBeforeCreate_(data, docType, this, arguments, var=var):
    ...
    var.registers(['fields', 'now', 'docType', 'prefixJ', 'initSpaces', 'line', 'otherTags', 'text', 'keys', 'data', 'i', 'prefix', 'rating'])
...
def PyJsHoisted_ontology2Labels_(ontology, tableFormat, this, arguments, var=var):
    ...
    var.registers(['tableFormat', 'ontology', 'dataDict', 'hierarchyDict'])
    var.put('dataDict', Js({}))
...
def PyJsHoisted_hierarchy2String_(data, addID, callback, detail, magicTags, this, arguments, var=var):
    ...
    var.registers(['id', 'outString', 'data', 'magicTags', 'hierarchyIDs', 'childNum', 'dataList', 'callback', 'j', 'key', 'value', 'keys', 'detail', 'compare', 'addID', 'i', 'hierString'])
    @Js
    ...
    def PyJs_anonymous_4_(item, this, arguments, var=var):
        var = Scope({'item':item, 'this':this, 'arguments':arguments}, var)
        var.registers(['doc', 'hierarchyArray', 'i1', 'item', 'i', 'i3', 'docID', 'i2', 'partString', 'spaces', 'prefix'])
...
def PyJsHoisted_editString2Docs_(text, magicTags, this, arguments, var=var):
    ...
    var.registers(['magicTags', 'objective', 'docType', 'parts', 'j', 'tags', 'comment', 'docI', 'line', 'text', 'docs', 'docID', 'i', 'title'])
    var.put('docs', Js([]))
...
def PyJsHoisted_getChildren_(data, docID, this, arguments, var=var):
    ...
    var.registers(['data', 'lines', 'ids', 'nStars', 'names', 'numStarsParent', 'items', 'docID', 'i', 'saveLine'])
    var.put('names', Js([]))
    var.put('ids', Js([]))
